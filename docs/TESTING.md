...
- `tests/Feature/TagLibraryDisplaySettingsTest.php`
  - covers the Options Tag Library collapsed/expanded display default setting, including hydration, persistence, modal-confirmed reset-to-default behavior, and stored option state
