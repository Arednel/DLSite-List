...
- `tests/Feature/ProductIndexLivewireTest.php`
  ...
  - DLSite and modal links: default Maniax links, enabled All Ages Home links, one reused external URL per product row, modal host metadata, and real standalone Quick Add/Edit `href` values
