...
<head>
    ...
    <link rel="preload" as="style" href="https://cdn.myanimelist.net/static/assets/css/pc/style-efe7646068.css">
    <link rel="preload" as="style" href="https://cdn.myanimelist.net/static/assets/css/pc/dark-84ab9757bf.css">
    <link rel="stylesheet" type="text/css" href="https://cdn.myanimelist.net/static/assets/css/pc/style-efe7646068.css">
    <link rel="stylesheet" type="text/css" href="https://cdn.myanimelist.net/static/assets/css/pc/dark-84ab9757bf.css">
                                ...
                                <td>
                                    ...
                                    <div style="text-align: left;">
                                        <div id="top-submit-buttons" class="mt8 mb8" style="text-align: center;">
                                            <input type="button" class="inputButton main_submit" value="Submit">
                                            <form style="display: inline-block;" id="delete-form" method="POST"
                                                action="#">
                                                <input type="button" class="inputButton ml8 delete_submit"
                                                    value="Delete">
                                            </form>
                                        </div>
                                        <form name="add_manga" method="post" id="main-form" class="recaptcha-form"
                                            data-recaptcha-action="tmp_user">
                                            <table cellpadding="5" cellspacing="0" width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td width="130" class="borderClass" valign="top">Title</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="borderClass">
                                                            <select id="add_manga_status" name="add_manga[status]"
                                                                class="inputtext">
                                                                <option value="1">Listening
                                                                </option>
                                                                <option value="2" selected>Completed</option>
                                                                <option value="3">On-Hold</option>
                                                                <option value="6">Plan to Listen</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="borderClass">
                                                            <select id="add_manga_score" name="add_manga[score]"
                                                                class="inputtext">
                                                                <option value="">Select score</option>
                                                                <option value="10">(10) Masterpiece</option>
                                                                <option value="9" selected="selected">(9) Great
                                                                </option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="borderClass">
                                                            <textarea id="add_manga_tags" name="add_manga[tags]" class="textarea" rows="3" cols="45">Virgin</textarea>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="borderClass">
                                                            <textarea id="add_manga_comments" name="add_manga[comments]" class="inputtext" rows="5" cols="45">[Low volume] Prince-like elf's small pussy squirts in seconds and has continuous orgasms - Only I know her vulgar true nature with her strong sexual desire -
                                                            </textarea>
                                                        </td>
                                                    </tr>
                                                </tbody>
